...
def parse(fp: TextIOBase, mapper: Type[T] = ..., merge_duplicate_keys: bool = ..., escaped: bool = ...) -> T: ...
def loads(s: str, mapper: Type[T] = ..., merge_duplicate_keys: bool = ..., escaped: bool = ...) -> T: ...
def load(fp: TextIOBase, mapper: Type[T] = ..., merge_duplicate_keys: bool = ..., escaped: bool = ...) -> T: ...
def dumps(obj: dict, pretty: bool = ..., escaped: bool = ...) -> str: ...
def dump(obj: dict, fp: TextIOBase, pretty: bool = ..., escaped: bool = ...) -> None: ...
